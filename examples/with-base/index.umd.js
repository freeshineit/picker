   ...
   */ var Picker = /*#__PURE__*/ (function () {
      ...
      if (this._options.trigger === "click")
        (_this_$container1 = this.$container) == null
          ...
          : (_this_$container_removeEventListener1 = _this_$container1.removeEventListener) == null
            ? void 0
            : _this_$container_removeEventListener1.call(_this_$container1, "click", this._onContainerClick);
      ...
      if (this._options.trigger === "click")
        (_this_$container1 = this.$container) == null
          ...
          : (_this_$container_addEventListener1 = _this_$container1.addEventListener) == null
            ? void 0
            : _this_$container_addEventListener1.call(_this_$container1, "click", this._onContainerClick);
      if (this._options.trigger === "hover") {
     ...
     */ _proto._onContainerClick = function _onContainerClick(event) {
      ...
      var contain =
        ((_this_$wrapperContent = this.$wrapperContent) == null
          ? void 0
          : (_this_$wrapperContent_contains = _this_$wrapperContent.contains) == null
            ? void 0
            : _this_$wrapperContent_contains.call(_this_$wrapperContent, event.target)) || this.$wrapperContent === event.target;
      // open 状态下触发关闭
